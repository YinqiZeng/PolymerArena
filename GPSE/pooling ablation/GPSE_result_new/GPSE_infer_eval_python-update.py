...
parser = argparse.ArgumentParser(description='GPSE GCN training with different pooling functions')
...
parser.add_argument('--dataset_cache_path', type=str, default='dataset_cache_gpse.pkl',
                    help='Path to save/load the cached dataset (default: dataset_cache_gpse.pkl)')
